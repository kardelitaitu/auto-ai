...
const { analyzeSentiment, shouldSkipAction, getSkipReason, getSafeActions, formatSentimentReport, shouldProcessContent } = sentimentGuard;
...
describe('sentiment-guard', () => {
  describe('analyzeSentiment', () => {
    ...
    it('should detect negative keywords in controversy category', () => {
      ...
      expect(result.isNegative).toBe(true);
      expect(result.categories).toContainEqual(expect.objectContaining({ name: 'controversy' }));
    });
