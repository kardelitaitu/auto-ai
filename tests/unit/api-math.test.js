...
describe('api/utils/math', () => {
  ...
  describe('mathUtils.gaussian', () => {
    it('should generate a number around the mean', () => {
      vi.spyOn(Math, 'random').mockImplementationOnce(() => 0.5).mockImplementationOnce(() => 0.5);
    ...
    it('should apply min boundary', () => {
      vi.spyOn(Math, 'random').mockImplementationOnce(() => 0.01).mockImplementationOnce(() => 0.5);
    ...
    it('should apply max boundary', () => {
      vi.spyOn(Math, 'random').mockImplementationOnce(() => 0.99).mockImplementationOnce(() => 0.5);
    ...
    it('should clamp result between min and max', () => {
      vi.spyOn(Math, 'random').mockImplementationOnce(() => 0.01).mockImplementationOnce(() => 0.99);
