...
import RoxybrowserDiscover from '../../../connectors/discovery/roxybrowser.js';
  ...
  describe('discover()', () => {
    ...
    it('should handle multiple profiles', async () => {
      mockApiHandler.get.mockResolvedValue({
        ...
        msg: 'Success',
        data: [
          { id: '1', ws: 'ws://1:1/devtools', http: 'http://1:1/json', sortNum: 1 },
          { id: '2', ws: 'ws://2:2/devtools', http: 'http://2:2/json', sortNum: 2 },
          { id: '3', ws: 'ws://3:3/devtools', http: 'http://3:3/json', sortNum: 3 },
        ]
      });
