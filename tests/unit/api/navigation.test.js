...
import { goto, reload, back, forward, setExtraHTTPHeaders } from '../../../api/interactions/navigation.js';
...
vi.mock('../../../api/behaviors/persona.js', () => ({
  getPersona: vi.fn().mockReturnValue({ scrollDelay: 100, scrollMin: 100, scrollMax: 300 })
}));
...
describe('api/interactions/navigation.js', () => {
  ...
  describe('goto', () => {
    ...
    it('should resolve on selector', async () => {
      mockPage.goto.mockImplementation(() => new Promise(r => setTimeout(r, 100)));
