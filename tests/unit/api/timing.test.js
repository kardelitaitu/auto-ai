...
import { think, delay, gaussian, randomInRange } from '../../../api/behaviors/timing.js';
...
describe('api/behaviors/timing.js', () => {
  ...
  describe('think', () => {
    it('should wait for specified duration', async () => {
      ...
      expect(humanTiming.humanDelay).toHaveBeenCalledWith(1000, expect.any(Object));
    ...
    it('should apply impatience multiplier if page is slow', async () => {
      ...
      expect(humanTiming.humanDelay).toHaveBeenCalledWith(750, expect.any(Object));
    });
