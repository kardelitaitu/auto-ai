...
import { recover, urlChanged, goBack, findElement, smartClick, undo } from '../../../api/behaviors/recover.js';
...
describe('api/behaviors/recover.js', () => {
  ...
  describe('smartClick', () => {
    ...
    it('should retry if click fails completely', async () => {
      ...
      mockLocator.click.mockRejectedValueOnce(new Error('Locator Click failed'));
