...
describe('ReferrerEngine Extra Coverage', () => {
    ...
    describe('HeaderEngine Catch Block', () => {
        it('should return empty headers for invalid target URL with non-direct strategy', () => {
            ...
            vi.spyOn(Math, 'random').mockReturnValue(0.20); // google_search strategy
    ...
    describe('Trampoline Navigation Edge Cases', () => {
        ...
        it.skip('should fallback to direct goto if trampoline setup fails (route error)', async () => {
            ...
            expect(mockPage.goto).toHaveBeenCalledWith(expect.stringContaining('https://target.com'), expect.objectContaining({
