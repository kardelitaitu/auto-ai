...
const testCases = [
    { name: 'Unicode Emoji', input: 'Hello world! 🌍🔥', expected: 'Hello world!' },
    { name: 'Simple Emoticon', input: 'Good morning :)', expected: 'Good morning' },
    ...
    { name: 'Embedded', input: 'He said :D is cool', expected: 'He said is cool' },
    { name: 'No Emojis', input: 'Just a normal sentence.', expected: 'Just a normal sentence.' },
    { name: 'Protocol Ignore', input: 'Check https://example.com', expected: 'Check https://example.com' }
];
