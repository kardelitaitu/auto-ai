...
export const applyEnvOverrides = (config) => EnvironmentConfig.applyEnvOverrides(config);
export const getSupportedEnvVars = () => environmentConfig.getSupportedEnvVars();
