...
import { getStrategyInstruction, getReplyLengthGuidance, getSentimentGuidance, REPLY_SYSTEM_PROMPT } from "../twitter-reply-prompt.js";
...
async function generateReply(engine, tweetText, authorUsername, context = {}) {
  ...
  for (let attempt = 1; attempt <= maxAttempts; attempt++) {
    try {
      ...
      const prompt = buildEnhancedPrompt(engine, tweetText, authorUsername, context, strategy);
