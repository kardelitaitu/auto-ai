...
// Base prompts
import { getBaseSystemPrompt, getStateDetectionPrompt, getActionSystemPrompt } from './base/system.js';
import { TILE_COLORS, PRICE_NUMBERS, BUILDING_ICONS, getTileVisualGuide, getMenuVisualGuide, getCompleteVisualReference } from './base/visual-guide.js';

// Shared utilities
import { scaleToViewport, scaleToVPrep, validateCoordinates, formatCoordinateConstraints, parseCoordinates, calculateDistance, getImageCenter } from './shared/coordinates.js';
import { validateStateDetection, validateCoordinateResponse, validateActionResponse, parseLLMJson, createValidationResult } from './shared/validation.js';

// State prompts
import stateA, { STATE_A, getStateAPrompt, validateResponse as validateStateA } from './states/state-a.js';
import stateB, { STATE_B, getStateBPrompt, validateResponse as validateStateB } from './states/state-b.js';
import stateC, { STATE_C, getStateCPrompt, validateResponse as validateStateC } from './states/state-c.js';
import stateD, { STATE_D, getStateDPrompt, validateResponse as validateStateD } from './states/state-d.js';
import stateE, { STATE_E, getStateEPrompt, validateResponse as validateStateE } from './states/state-e.js';
...
export function getStatePrompt(stateKey, options = {}) {
    ...
    if (!getter) {
        throw new Error(`Unknown state: ${stateKey}. Valid states: ${Object.keys(STATES).join(', ')}`);
    }
