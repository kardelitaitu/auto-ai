    ...
    io.on('connection', (socket) => {
        ...
        socket.on('task-update', withAuth('task-update', (data) => {
            ...
            if (validated) {
                ...
                server.latestMetrics.recentTasks = server.dashboardData.tasks.slice(-40);
        ...
        socket.on('clear-history', withAuth('clear-history', () => {
            ...
            server.dashboardData.twitterActions = { likes: 0, retweets: 0, replies: 0, quotes: 0, follows: 0, bookmarks: 0, total: 0 };
            ...
            if (server.latestMetrics.metrics) {
                server.latestMetrics.metrics.twitter = { actions: { likes: 0, retweets: 0, replies: 0, quotes: 0, follows: 0, bookmarks: 0, total: 0 } };
                server.latestMetrics.metrics.api = { calls: 0, failures: 0, successRate: 100, avgResponseTime: 0 };
            }
