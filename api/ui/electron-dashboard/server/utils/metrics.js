...
export function getSystemMetrics(lastCpuInfo = null) {
    try {
        ...
        return {
            ...
            memory: {
                total: Math.round((totalMem / BYTES_PER_GB) * MEMORY_PRECISION) / MEMORY_PRECISION,
                used: Math.round((usedMem / BYTES_PER_GB) * MEMORY_PRECISION) / MEMORY_PRECISION,
                free: Math.round((freeMem / BYTES_PER_GB) * MEMORY_PRECISION) / MEMORY_PRECISION,
                percent: memPercent,
            },
