...
describe('HistoryManager', () => {
    ...
    describe('initialization', () => {
        it('should initialize with empty data', () => {
            ...
            expect(manager.getTwitterActions()).toEqual({
                ...
                follows: 0, bookmarks: 0, total: 0
            });
            expect(manager.getApiMetrics()).toEqual({
                calls: 0, failures: 0, successRate: 100, avgResponseTime: 0
            });
        });
    ...
    describe('addOrUpdateTask', () => {
        it('should add a new task', () => {
            ...
            const task = { id: 'task-1', taskName: 'followUser', sessionId: 'session-1' };
        ...
        it('should update existing task', () => {
            ...
            const updatedTask = { id: 'task-1', taskName: 'followUser', success: true };
    ...
    describe('field normalization', () => {
        ...
        it('should use sessionId over session', () => {
            const manager = new HistoryManager(historyFilePath, 40, 1);
            manager.addOrUpdateTask({ session: 'sessionValue', sessionId: 'sessionIdValue' });
            manager.flushSave();
            const tasks = manager.getTasks();
            if (tasks.length > 0) {
