...
describe('WebSocket Integration Tests', () => {
    ...
    describe('Authentication', () => {
        it('should handle push_metrics event (auth tested in unit tests)', async () => {
            ...
            const hasSession = server.latestMetrics.sessions?.some(
                s => s.id === 'test-session'
            ) || false;
    ...
    describe('Data Sanitization', () => {
        ...
        it('should sanitize task data (remove control characters)', async () => {
            ...
            const task = metrics.recentTasks?.find(t => t.taskName?.includes('Task'));
            if (task) {
    ...
    describe('Metrics Collection', () => {
        ...
        it('should update metrics when pushed', async () => {
            ...
            expect(metrics.sessions.some(s => s.id === 'test-session-123')).toBe(true);
        });
    });
});
