    ...
    return (
        <div style={{ 
            ...
            {tasks.slice().reverse().map((task, index) => {
                ...
                const isSuccess = task.success === true || task.status === 'completed' || task.status === 'OK';
                ...
                return (
                    <div key={task.id || index} style={{
                        ...
                        <span style={{ color: 'var(--text-dim)', minWidth: '70px', flexShrink: 0 }}>{session}</span>
                        ...
                        <span style={{ flexShrink: 0 }}>-</span>
                        <span style={{
                            color: isSuccess ? 'var(--accent-success)' : 'var(--accent-error)',
                            fontWeight: '700',
                            minWidth: '50px',
                            flexShrink: 0
                        }}>
                        ...
                        {timeAgo && (
                            <>
                                <span style={{ flexShrink: 0 }}>-</span>
                                <span style={{ color: 'var(--text-dim)', fontSize: '10px', flexShrink: 0 }}>{timeAgo}</span>
                            </>
                        )}
                    </div>
                );
