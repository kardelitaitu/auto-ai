      ...
      `}</style>
            ...
            <header style={styles.header}>
                <h1 style={styles.logo}>
                    Auto<span style={styles.logoAccent}>-AI</span>
                </h1>
            ...
            <div style={styles.topStatusBar}>
                <div style={styles.metricBar}>
                    ...
                    <span style={{ ...styles.barValue, color: getPercentColor(cpuUsage) }}>
                        {cpuUsage}%
                    </span>
                </div>
                <div style={styles.metricBar}>
                    ...
                    <span style={{ ...styles.barValue, color: getPercentColor(memPercent) }}>
                        {memPercent}%
                    </span>
                </div>
            ...
            <div style={styles.metricsGrid}>
                ...
                <div style={styles.card}>
                    ...
                    <div style={{ ...styles.cardValue, ...styles.cardValueBlue }}>
                        {queueLength}{' '}
                        <span style={{ fontSize: '12px', color: '#666' }}>({queuePercent}%)</span>
                    </div>
                </div>
                <div style={styles.card}>
            ...
            <div style={styles.compactList}>
                {recentTasks.length === 0 ? (
                    <div style={{ ...styles.listItem, justifyContent: 'center', color: '#555' }}>
                        No recent tasks
                    </div>
                ) : (
                    recentTasks.slice(0, 6).map((task, index) => {
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...styles.listItem,
                                    ...(index === Math.min(recentTasks.length - 1, 5)
                                        ? styles.listItemLast
                                        : {}),
                                }}
                            >
                                <div
                                    style={{
                                        ...
                                        ...(isSuccess
                                            ...
                                            : isError
                                              ? styles.taskIconError
                                              : { backgroundColor: '#ffa502' }),
                                    }}
                                ></div>
                                <span style={styles.taskName}>
                                    {safeGet(task, 'name', 'Unknown')}
                                </span>
                                <span style={styles.taskDuration}>
                                    {safeGet(task, 'duration', '0s')}
                                </span>
                    ...
                    sessions.slice(0, 6).map((session, index) => {
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...styles.listItem,
                                    ...(index === Math.min(sessions.length - 1, 5)
                                        ? styles.listItemLast
                                        : {}),
                                }}
                            >
                                ...
                                <span
                                    style={{
                                        ...
                                        ...(isOnline
                                            ? styles.statusOnlineBg
                                            : isIdle
                                              ? styles.statusIdleBg
                                              : styles.statusOfflineBg),
                                    }}
                                >
