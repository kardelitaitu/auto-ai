...
const _logger = createLogger('api/agent/errorRecoveryPrompt.js');

class ErrorRecoveryPrompt {
    constructor() {
        this.errorPatterns = {
            selector_not_found: {
                patterns: ['selector', 'not found', 'no element', 'element not found', 'cannot find'],
                recovery: [
            ...
            element_not_visible: {
                patterns: ['not visible', 'hidden', 'obscured', 'out of view', 'not in viewport'],
                recovery: [
            ...
            timeout: {
                patterns: ['timeout', 'timed out', 'wait timed out', 'navigation timeout'],
                recovery: [
                    'Increase wait time',
            ...
            action_failed: {
                patterns: ['action failed', 'execution failed', 'click failed', 'type failed'],
                recovery: [
