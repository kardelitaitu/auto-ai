...
class IntentClassifier {
    constructor() {
        this.routineActions = new Set(['click', 'type', 'scroll', 'hover', 'wait', 'goto', 'reload', 'back', 'forward', 'press', 'fill', 'selectOption', 'check', 'uncheck']);
        this.complexActions = new Set(['captcha_solve', 'login', 'signup', 'dm', 'post', 'tweet', 'retweet', 'reply', 'follow', 'unfollow', 'bookmark', 'like', 'unlike', 'quote', 'edit_profile', 'upload_media', 'create_list', 'join_list', 'leave_list', 'mute', 'block', 'unblock', 'report', 'search_advanced', 'filter', 'schedule', 'draft', 'analytics', 'settings', 'verify', 'promote', 'advertise']);
        this.errorKeywords = ['rate limit', 'rate_limit', 'too many requests', 'blocked', 'suspended', 'locked', 'verify your account', 'suspicious', 'unusual login', 'password', 'captcha', '2fa', 'verification'];
    }
