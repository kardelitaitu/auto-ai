...
describe('TwitterAgent', () => {
    ...
    beforeEach(async () => {
        vi.clearAllMocks();
        TwitterAgent = (await import('../../../twitter/twitterAgent.js')).TwitterAgent;
    ...
    describe('log', () => {
        it('should log with logger', () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith('[Agent:test-agent] test message');
        });
        ...
        it('should fallback to console.log without logger', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('[Agent:test-agent] test message');
    ...
    describe('getScrollMethod', () => {
        it('should return valid scroll method', () => {
            ...
            const validMethods = ['WHEEL_DOWN', 'WHEEL_UP', 'SPACE', 'KEYS_DOWN', 'KEYS_UP'];
    ...
    describe('performHealthCheck', () => {
        ...
        it('should detect redirect errors in page content', async () => {
            ...
            const hasError = testContent.includes('This page isn\'t working') ||
    ...
    describe('isElementActionable', () => {
        it('should return false for null element', async () => {
            ...
            const agent = new TwitterAgent(mockPage, config, mockLogger);
            const result = await agent.isElementActionable({ elementHandle: vi.fn().mockResolvedValue(null) });
