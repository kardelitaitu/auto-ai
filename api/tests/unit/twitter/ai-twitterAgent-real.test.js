...
import { AITwitterAgent as AITwitterAgentClass } from "../../../twitter/ai-twitterAgent.js";
...
vi.mock("../actions/ai-twitter-reply.js", () => ({ AIReplyAction: vi.fn() }));
vi.mock("../actions/ai-twitter-quote.js", () => ({ AIQuoteAction: vi.fn() }));
vi.mock("../actions/ai-twitter-like.js", () => ({ LikeAction: vi.fn() }));
vi.mock("../actions/ai-twitter-bookmark.js", () => ({
  BookmarkAction: vi.fn(),
}));
vi.mock("../actions/ai-twitter-retweet.js", () => ({ RetweetAction: vi.fn() }));
vi.mock("../actions/ai-twitter-go-home.js", () => ({ GoHomeAction: vi.fn() }));
vi.mock("../actions/ai-twitter-follow.js", () => ({ FollowAction: vi.fn() }));
