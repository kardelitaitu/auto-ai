...
class LogCapture {
    constructor(orchestrator) {
        ...
        this.allowedModules = new Set(['ai-twitterActivity', 'ai-twitterAgent', 'agent', 'pageview', 'twitterFollow', 'twitterTweet', 'twitterFollowLikeRetweet', 'runAgent', 'taskAgent']);
...
describe('LogCapture', () => {
  ...
  it('handles allowed log entries and updates activity', () => {
    ...
    expect(orchestrator.updateSessionProcessing).toHaveBeenCalledWith('s1', '[taskOne] User opened timeline');
