...
describe('Orchestrator', () => {
    ...
    describe('formatSessionDisplayName', () => {
        it('should format session display names correctly', () => {
            expect(
                orchestrator._formatSessionDisplayName({ type: 'localChrome', port: 9222 })
            ).toBe('chrome:9222');
            expect(
    ...
    describe('Task Processing', () => {
        it('should distribute tasks to sessions', async () => {
            ...
            const mockSession = {
                ...
                browser: {
                    contexts: () => [],
                    newContext: vi.fn().mockResolvedValue({ newPage: vi.fn(), close: vi.fn() }),
                },
                workers: [],
            };
            ...
            expect(checklistSpy).toHaveBeenCalledWith(
                mockSession,
                expect.arrayContaining([expect.objectContaining({ taskName: 'mockTask' })])
            );
