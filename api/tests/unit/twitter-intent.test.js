...
describe('Twitter Intent Helpers', () => {
    ...
    describe('intent-like', () => {
        it('should navigate to like intent and confirm', async () => {
            ...
            expect(goto).toHaveBeenCalledWith('https://x.com/intent/like?tweet_id=123456');
            expect(click).toHaveBeenCalledWith('[data-testid="confirmationSheetConfirm"]');
        ...
        it('should trigger timeout if operation takes more than 20s', async () => {
            vi.useFakeTimers();
            goto.mockImplementationOnce(() => new Promise(resolve => setTimeout(resolve, 30000)));
    ...
    describe('intent-retweet', () => {
        it('should navigate to retweet intent and confirm', async () => {
            ...
            expect(res.success).toBe(true);
            expect(goto).toHaveBeenCalledWith('https://x.com/intent/retweet?tweet_id=123456');
            expect(click).toHaveBeenCalledWith('[data-testid="confirmationSheetConfirm"]');
            expect(back).toHaveBeenCalled();
        });
    ...
    describe('intent-quote', () => {
        ...
        it('should handle multiline text correctly', async () => {
            ...
            expect(goto).toHaveBeenCalledWith(expect.stringContaining('text=Line%201%0ALine%202'));
        });
    ...
    describe('intent-follow', () => {
        it('should navigate to follow intent and confirm', async () => {
            ...
            expect(res.success).toBe(true);
            expect(goto).toHaveBeenCalledWith('https://x.com/intent/follow?screen_name=username');
            expect(click).toHaveBeenCalledWith('[data-testid="confirmationSheetConfirm"]');
            expect(back).toHaveBeenCalled();
        });
        ...
        it('should handle complex URLs and extract username', async () => {
            ...
            expect(res.success).toBe(true);
            expect(goto).toHaveBeenCalledWith('https://x.com/intent/follow?screen_name=testuser');
        });
