...
describe('api/agent/observer.js', () => {
    ...
    describe('see', () => {
        ...
        it('should handle elements with special characters in labels', async () => {
            const mockElements = [{ id: 1, role: 'button', label: 'Submit & Continue >' }];
            mockPage.evaluate.mockResolvedValue(mockElements);
    ...
    it('should process button elements', () => {
        ...
        const mockDoc = {
            ...
            defaultView: {
                getComputedStyle: vi
                    .fn()
                    .mockReturnValue({ display: 'block', visibility: 'visible', opacity: '1' }),
            },
        };
    ...
    it('should skip hidden elements', () => {
        ...
        const mockDoc = {
            ...
            defaultView: {
                getComputedStyle: vi
                    .fn()
                    .mockReturnValue({ display: 'none', visibility: 'visible', opacity: '1' }),
            },
        };
...
describe('api/agent/executor.js', () => {
    ...
    describe('doAction', () => {
        ...
        it('should hover over element', async () => {
            const mockElements = [{ id: 1, role: 'link', label: 'Menu', selector: '#menu-link' }];
