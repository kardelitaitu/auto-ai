...
describe('ai-twitterActivity Task', () => {
            ...
            const validated = {
                replies:
                    typeof invalidLimits.replies === 'number' && invalidLimits.replies > 0
                        ...
                        : 3,
                retweets:
                    typeof invalidLimits.retweets === 'number' && invalidLimits.retweets > 0
                ...
                follows:
                    typeof invalidLimits.follows === 'number' && invalidLimits.follows > 0
                        ...
                        : 2,
                bookmarks:
                    typeof invalidLimits.bookmarks === 'number' && invalidLimits.bookmarks > 0
    ...
    describe('Timeout Calculations', () => {
        it('should calculate hard timeout from payload', () => {
            ...
            const DEFAULT_MAX_DURATION = 540;
            const hardTimeoutMs =
                payload.taskTimeoutMs || (DEFAULT_MIN_DURATION + DEFAULT_MAX_DURATION) * 1000;
    ...
    describe('Final Stats Reporting', () => {
        it('should calculate engagement totals correctly', () => {
            ...
            const totalEngagements =
                agent.state.follows + agent.state.likes + agent.state.retweets + agent.state.tweets;
    ...
    describe('Zero Values', () => {
        it('should handle zero engagement limits', () => {
            ...
            const validatedLimits = {
                replies:
                    typeof engagementLimits.replies === 'number' && engagementLimits.replies > 0
                        ? engagementLimits.replies
                        : 3,
                likes:
                    typeof engagementLimits.likes === 'number' && engagementLimits.likes > 0
