...
describe('api/agent/promptAdapter.js', () => {
    ...
    describe('Constructor', () => {
        ...
        it('should have examples for each page type', () => {
            ...
            expect(promptAdapter.pageTypes.navigation.examples.length).toBeGreaterThan(0);
        });
    });
    ...
    describe('detectPageType()', () => {
        it('should detect form page from content', () => {
            ...
            const result = promptAdapter.detectPageType(axTree, 'https://example.com/login');
            expect(result).toBe('form');
        });

        it('should detect social page from URL containing social keywords', () => {
            const axTree = { name: 'Page', children: [] };
            const result = promptAdapter.detectPageType(axTree, 'https://social.example.com/home');
        ...
        it('should detect game page from content', () => {
            ...
            const result = promptAdapter.detectPageType(axTree, 'https://example.com/game');
        ...
        it('should detect ecommerce page', () => {
            ...
            const result = promptAdapter.detectPageType(axTree, 'https://shop.example.com/product');
        ...
        it('should detect navigation page', () => {
            ...
            const result = promptAdapter.detectPageType(axTree, 'https://example.com');
        ...
        it('should detect content page as default', () => {
            const axTree = {
                name: 'Article',
                children: [
                    { name: 'Hello World', role: 'heading' },
                ],
            };
            const result = promptAdapter.detectPageType(axTree, 'https://blog.example.com/post');
        ...
        it('should handle JSON string input', () => {
            ...
            const result = promptAdapter.detectPageType(axTreeJson, 'https://example.com');
            expect(result).toBe('form');
        });

        it('should return unknown for invalid JSON', () => {
            const result = promptAdapter.detectPageType('invalid json', 'https://example.com');
    ...
    describe('generateContextualPrompt()', () => {
        it('should generate prompt for form page', () => {
            const result = promptAdapter.generateContextualPrompt('form', 'login to account', null);
            expect(result).toContain('form');
            expect(result).toContain('Rules');
        });

        it('should generate generic prompt for unknown page', () => {
            const result = promptAdapter.generateContextualPrompt('unknown', 'do something', null);
            expect(result).toContain('general web page');
        });

        it('should include goal-specific tips', () => {
            const result = promptAdapter.generateContextualPrompt('form', 'login to my account', null);
    ...
    describe('_generateGoalTips()', () => {
        ...
        it('should generate tips for search goals', () => {
            const tips = promptAdapter._generateGoalTips('search for products', 'ecommerce');
            expect(tips).toContain('search');
        });

        it('should generate tips for purchase goals', () => {
            const tips = promptAdapter._generateGoalTips('buy a product', 'ecommerce');
            expect(tips).toContain('cart');
            expect(tips).toContain('checkout');
        });

        it('should generate tips for navigation goals', () => {
            const tips = promptAdapter._generateGoalTips('navigate to page', 'content');
            expect(tips).toContain('navigation');
        });

        it('should generate generic tips for unknown goals', () => {
            const tips = promptAdapter._generateGoalTips('do something random', 'content');
    ...
    describe('enhancePrompt()', () => {
        it('should enhance base prompt with context', () => {
            ...
            const enhanced = promptAdapter.enhancePrompt(basePrompt, 'form', 'login', null);
        ...
        it('should handle unknown page type', () => {
            const enhanced = promptAdapter.enhancePrompt('Base', 'unknown', 'task', null);
