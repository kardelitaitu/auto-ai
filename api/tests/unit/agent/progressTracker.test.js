...
describe('api/agent/progressTracker.js', () => {
    ...
    describe('recordStep()', () => {
        ...
        it('should increment actionsFailed for failed actions', () => {
            progressTracker.recordStep(1, { action: 'click' }, { success: false, error: 'Failed' });
        ...
        it('should include elapsed time in event', () => {
            ...
            const event = listener.mock.calls.find(call => call[0].event === 'step:complete');
    ...
    describe('recordStuck()', () => {
        ...
        it('should include metrics in event', () => {
            ...
            const event = listener.mock.calls.find(call => call[0].event === 'agent:stuck');
    ...
    describe('completeSession()', () => {
        ...
        it('should include duration in event', () => {
            ...
            const event = listener.mock.calls.find(call => call[0].event === 'session:complete');
    ...
    describe('_emit()', () => {
        it('should handle wsServer emit errors gracefully', () => {
            const failingServer = {
                emit: vi.fn(() => { throw new Error('WS Error'); }),
            };
