...
describe('api/agent/sessionStore.js', () => {
    ...
    describe('_extractUrlPattern()', () => {
        it('should extract hostname and path up to 2 segments', () => {
            const pattern = sessionStore._extractUrlPattern('https://example.com/path/to/page?id=123');
        ...
        it('should handle URLs with single path segment', () => {
            const pattern = sessionStore._extractUrlPattern('https://example.com/page');
        ...
        it('should strip query parameters', () => {
            const pattern = sessionStore._extractUrlPattern('https://example.com/path?foo=bar&baz=qux');
    ...
    describe('recordAction()', () => {
        ...
        it('should store action pattern in memoryStore', () => {
            ...
            sessionStore.recordAction('https://example.com/page', '#submit', 'click', true);
        ...
        it('should extract URL pattern from full URL', () => {
            ...
            sessionStore.recordAction('https://example.com/path/to/page?id=123', '#btn', 'click', true);
    ...
    describe('getActionSuccessRate()', () => {
        it('should return 0.5 when disabled', () => {
            ...
            const rate = sessionStore.getActionSuccessRate('https://example.com', '#btn', 'click');
    ...
    describe('learnSelector()', () => {
        it('should not learn when disabled', () => {
            ...
            // Should not throw
            expect(() => {
                sessionStore.learnSelector('https://example.com', 'Submit button', '#submit', true);
            }).not.toThrow();
        ...
        it('should record successful selector', () => {
            ...
            sessionStore.learnSelector('https://example.com', 'Login button', '#login', true);
        ...
        it('should record failed selector', () => {
            ...
            sessionStore.learnSelector('https://example.com', 'Login button', '#login', false);
    ...
    describe('getBestSelector()', () => {
        it('should return null when disabled', () => {
            ...
            const selector = sessionStore.getBestSelector('https://example.com', 'Submit button');
