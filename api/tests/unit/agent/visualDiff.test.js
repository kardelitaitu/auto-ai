...
describe('api/agent/visualDiff.js', () => {
    ...
    describe('_fallbackComparison', () => {
        it('should compare buffers by length difference', () => {
            ...
            const result = visualDiffEngine._fallbackComparison(preBuffer, postBuffer);
        ...
        it('should handle null buffers', () => {
            const result = visualDiffEngine._fallbackComparison(null, Buffer.from('test'));
    ...
    describe('identifyChangedRegions', () => {
        it('should identify changed regions using sharp', async () => {
            ...
            const result = await visualDiffEngine.identifyChangedRegions(preBuffer, postBuffer);
    ...
    describe('_floodFill', () => {
        it('should fill connected region and return bounding box', () => {
            ...
            const region = visualDiffEngine._floodFill(buffer, 5, 5, 256, 256, visited);
        ...
        it('should handle out of bounds coordinates', () => {
            ...
            const region = visualDiffEngine._floodFill(buffer, -1, -1, 256, 256, visited);
