...
import { adaptiveTiming } from '../../../agent/adaptiveTiming.js';
...
describe('api/agent/adaptiveTiming.js', () => {
    ...
    describe('getTimingForSite', () => {
        it('should return cached profile for exact URL match', () => {
            ...
            const testProfile = { click: 150, type: 75, navigation: 3000, waitMultiplier: 1.5 };
    ...
    describe('getAdjustedDelay', () => {
        it('should return adjusted delay for click action', () => {
            ...
            const testProfile = { click: 100, type: 50, navigation: 2000, waitMultiplier: 1.5 };
            adaptiveTiming.siteProfiles.set(testUrl, testProfile);
        ...
        it('should return adjusted delay for type action', () => {
            const testUrl = 'https://example.com';
            const testProfile = { click: 100, type: 50, navigation: 2000, waitMultiplier: 2.0 };
            adaptiveTiming.siteProfiles.set(testUrl, testProfile);
        ...
        it('should return adjusted delay for navigation action', () => {
            const testUrl = 'https://example.com';
            const testProfile = { click: 100, type: 50, navigation: 2000, waitMultiplier: 1.0 };
            adaptiveTiming.siteProfiles.set(testUrl, testProfile);

            const delay = adaptiveTiming.getAdjustedDelay(testUrl, 'navigation', 2000);
        ...
        it('should use default timing for unknown site', () => {
            const delay = adaptiveTiming.getAdjustedDelay('https://unknown.com', 'click', 100);
