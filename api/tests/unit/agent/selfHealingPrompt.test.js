...
describe('api/agent/selfHealingPrompt.js', () => {
    ...
    describe('_classifyError()', () => {
        it('should classify selector errors', () => {
            expect(selfHealingPrompt._classifyError('Selector not found')).toBe('selector_not_found');
            expect(selfHealingPrompt._classifyError('Element not found')).toBe('selector_not_found');
        });

        it('should classify visibility errors', () => {
            expect(selfHealingPrompt._classifyError('Not visible')).toBe('element_not_visible');
            expect(selfHealingPrompt._classifyError('Element hidden')).toBe('element_not_visible');
        });
    ...
    describe('_normalizeUrl()', () => {
        it('should normalize valid URLs', () => {
            const normalized = selfHealingPrompt._normalizeUrl('https://example.com/path?q=1');
    ...
    describe('_stringSimilarity()', () => {
        ...
        it('should calculate similarity based on word overlap', () => {
            const similarity = selfHealingPrompt._stringSimilarity('click submit button', 'click send button');
