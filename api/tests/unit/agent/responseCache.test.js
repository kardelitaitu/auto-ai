...
describe('api/agent/responseCache.js', () => {
    ...
    describe('_stringSimilarity', () => {
        ...
        it('should return higher similarity for similar strings', () => {
            const sim = responseCache._stringSimilarity('click submit button', 'click the submit button');
            expect(sim).toBeGreaterThan(0.5);
        });

        it('should return lower similarity for different strings', () => {
            const sim = responseCache._stringSimilarity('hello world', 'goodbye universe');
    ...
    describe('_calculateSimilarity', () => {
        it('should weight URL at 40%, goal at 40%, pageType at 20%', () => {
            const ctx1 = { url: 'https://example.com', goal: 'test', pageType: 'form' };
            const ctx2 = { url: 'https://example.com', goal: 'test', pageType: 'form' };
    ...
    describe('clear', () => {
        it('should clear all cached entries', () => {
            responseCache.set({ url: 'https://example.com/1', goal: 'test' }, { data: 1 });
            responseCache.set({ url: 'https://example.com/2', goal: 'test' }, { data: 2 });
    ...
    describe('cleanup', () => {
        ...
        it('should return 0 when no entries are expired', () => {
            responseCache.set({ url: 'https://example.com', goal: 'test' }, { data: 1 });
