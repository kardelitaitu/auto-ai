...
import { taskConfigLoader, TaskConfigLoader, loadAiTwitterActivityConfig } from '@api/utils/task-config-loader.js';
    ...
    describe('buildConfig', () => {
        it('should build configuration with all sections', () => {
            ...
            const mockConfig = {
                ...
                activityConfig: { defaultCycles: 10, defaultMinDuration: 300, defaultMaxDuration: 540 },
                timingConfig: { warmupMin: 2000, warmupMax: 15000, scrollMin: 300, scrollMax: 700, readMin: 5000, readMax: 15000 },
