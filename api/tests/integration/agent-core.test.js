...
vi.mock("../../agent/memoryInjector.js", () => ({
...
// Mock retry strategy
vi.mock("../../agent/retryStrategy.js", () => ({
...
vi.mock("../../agent/responseValidator.js", () => ({
...
// Mock response cache
vi.mock("../../agent/responseCache.js", () => ({
...
vi.mock("../../agent/historyManager.js", () => ({
...
// Mock error recovery
vi.mock("../../agent/errorRecoveryPrompt.js", () => ({
...
vi.mock("../../agent/selfHealingPrompt.js", () => ({
...
describe("Agent Core Integration", () => {
  ...
  describe("LLM Provider", () => {
    it("should generate responses with correct model", async () => {
      const LLMProvider = (await import("../../agent/llm-provider.js")).default;
  ...
  describe("Observer", () => {
    it("should observe page state and history", async () => {
      const Observer = (await import("../../agent/observer.js")).default;
  ...
  describe("Memory Injector", () => {
    it("should inject and retrieve memories", async () => {
      const MemoryInjector = (await import("../../agent/memoryInjector.js"))
        .default;
  ...
  describe("Retry Strategy", () => {
    it("should retry failed operations up to max retries", async () => {
      const RetryStrategy = (await import("../../agent/retryStrategy.js"))
        .default;
  ...
  describe("Response Validator", () => {
    it("should validate required fields", async () => {
      const ResponseValidator = (
        await import("../../agent/responseValidator.js")
      ).default;
  ...
  describe("Response Cache", () => {
    it("should cache and retrieve responses", async () => {
      const ResponseCache = (await import("../../agent/responseCache.js"))
        .default;
  ...
  describe("History Manager", () => {
    it("should add and retrieve history entries", async () => {
      const HistoryManager = (await import("../../agent/historyManager.js"))
        .default;
  ...
  describe("Error Recovery", () => {
    it("should import error recovery module", async () => {
      const ErrorRecoveryPrompt = (
        await import("../../agent/errorRecoveryPrompt.js")
      ).default;
  ...
  describe("Self-Healing", () => {
    it("should generate healing prompts from failures", async () => {
      ...
      const SelfHealingPrompt = (
        await import("../../agent/selfHealingPrompt.js")
      ).default;
