...
if (!isSilent) {
    ...
    console.log(`Coverage Engine: v8 (Native V8 Coverage)`);
    console.log(`=================================================\n`);
}
...
const coverageRoot = resolve(rootDir, 'api/coverage-v8');
...
// ============================================================================
// Module C: Core Vitest Configuration (V8 Variant)
// ============================================================================
export default defineConfig({
    test: {
        ...
        // --------------------------------------------------------------------
        // Coverage Engine - V8 Native Variant (Faster)
        // --------------------------------------------------------------------
        coverage: {
            provider: 'v8',
